...
function Register() {
  ...
  const validateData = () => {
    if (!validation.validateLength(firstname, 3, 30)) {
      setValidFirstName([
        false,
        "First name has to be between 3 and 30 characters!",
      ]);
      return false;
    } else {
    ...
    if (!validation.validateLength(lastname, 3, 30)) {
      setValidLastName([
        false,
        "Last name has to be between 3 and 30 characters!",
      ]);
      return false;
    } else {
    ...
    if (!validation.validateLength(password, 6, 30)) {
      setValidPassword([
        false,
        "Password has to be between 6 and 120 characters!",
      ]);
      return false;
    } else {
              ...
              <FormControl sx={{ width: "100%" }}>
                <Stack spacing={2}>
                  <IconTextField
                    ...
                    helperText={
                      validFirstname[0] === false ? validFirstname[1] : null
                    }
                  />
                  ...
                  <IconTextField
                    ...
                    helperText={
                      validLastname[0] === false ? validLastname[1] : null
                    }
                  />
                  ...
                  <TextField
                    ...
                    onChange={(newValue) => {
                      setPassword(validation.cleanValue(newValue.target.value));
                    }}
                    error={!validPassword[0]}
                    helperText={
                      validPassword[0] === false ? validPassword[1] : null
                    }
                    InputProps={{
                      startAdornment: (
